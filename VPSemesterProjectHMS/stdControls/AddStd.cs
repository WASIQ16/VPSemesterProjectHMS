    ...
    public partial class AddStd : UserControl
    {
        ...
        private void gunaAdvenceButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "INSERT INTO StudentsRecord(RegNo,Name,FatherName,ContactNo,GuardianNo,City,Province,Class,Department,RoomNo,Floor,MessBill,FeeStatus,OnLeave,Date,CNIC, Attendence)VALUES('" + RegNo + "','" + Name + "','" + FatherName + "','" + ContactNo + "','" + GuardianNo + "','" + City + "','" + Province + "','" + Class + "','" + Department + "','" + RoomNo + "','" + Floor + "','" + MessBill + "','" + FeeStatus + "','" + OnLeave + "','" + Date + "','" + CNIC + "' ,'" + Attendence + "')";
